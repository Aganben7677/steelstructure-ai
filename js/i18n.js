const i18n = {
  en: {
    ...
    home_eyebrow: "Global steel structure intelligence",
    home_subtitle: "Track EPC awards, modular fabrication demand, supply-chain capacity, and technical references in one focused workspace.",
    home_cta: "View EPC Updates →",
    home_cta_secondary: "Open Supply Map",
  ...
  zh: {
    ...
    home_eyebrow: "全球钢结构情报",
    home_subtitle: "在一个专注工作台中跟踪EPC授标、模块化制造需求、供应链产能和技术资料。",
    home_cta: "查看EPC动态 →",
    home_cta_secondary: "打开供应链地图",
